...
namespace System.Web.Http
{
    ...
    public static class HttpConfigurationExtensions
    {
        ...
        /// A sample WebHook URI is '<c>https://&lt;host&gt;/api/webhooks/incoming/workitems/{id}?code=83699ec7c1d794c0c780e49a5c72972590571fd8</c>'.
        /// For security reasons the WebHook URI must be an <c>https</c> URI and contain a 'code' query parameter with the
        /// same value as configured in the '<c>MS_WebHookReceiverSecret_WorkItems</c>' application setting, optionally using IDs
        ...
        public static void InitializeReceiveWorkItemsWebHooks(this HttpConfiguration config)
        {
